...
class TestMarks:
    def test_full(self, studentDmitry, full_journal):
        ...
        assert (
            text
            == "Дмитрий\nРусский язык. Изложение 2 Изложение 4\nМатематика. Работа на уроке 3 Опоздание\nХимия. Прогул"
        )
        assert (
            tts
            == "У дмитрия sil<[200]>Русский язык Изложение 2 Изложение 4 sil<[200]>Математика Работа на уроке 3 Опоздание sil<[200]>Химия Прогул"
        )
